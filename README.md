...
* [continuedev/continue](https://github.com/continuedev/continue) ⭐ 35,598 | 🐛 934 | 🌐 TypeScript | 📅 2026-08-22 - Open-source AI code agent with IDE extensions, CLI tool, and source-controlled AI checks enforceable in CI.
* [Tabby](https://github.com/TabbyML/tabby) ⭐ 33,833 | 🐛 330 | 🌐 Rust | 📅 2026-06-30 - Self-hosted AI coding assistant, open-source alternative to GitHub Copilot with code completion and repository-level context.
* [avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,126 | 🐛 47 | 🌐 Lua | 📅 2026-08-22 - Neovim plugin designed to emulate the behavior of the Cursor AI IDE with AI-driven code suggestions.
...
* [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,820 | 🐛 14 | 🌐 Lua | 📅 2026-08-21 - Neovim plugin for AI-assisted coding with agents, slash commands, and multiple LLM support.
...
* [bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,791 | 🐛 131 | 🌐 TypeScript | 📅 2026-02-07 - Open-source version of Bolt.new with Electron desktop apps, 19+ AI providers, and local model support via Ollama.

* [Superset](https://github.com/superset-sh/superset) ⭐ 13,236 | 🐛 547 | 🌐 TypeScript | 📅 2026-08-23 - Desktop app to orchestrate multiple AI coding agents in parallel (Claude Code, Codex, etc.) with Git worktree isolation.
...
* 🔥 [anthropics/claude-code](https://github.com/anthropics/claude-code) ⭐ 142,587 | 🐛 15,090 | 🌐 Python | 📅 2026-08-23 - Coding agent that understands your codebase, automates tasks, explains code, and manages Git, all via natural language.
* [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 113,723 | 🐛 13,501 | 🌐 Rust | 📅 2026-08-23 - OpenAI's coding agent in the terminal with Codex Cloud, IDE extension, and multi-model support.
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,619 | 🐛 791 | 🌐 TypeScript | 📅 2026-08-23 - An open-source AI agent from Google that brings the power of Gemini directly into your terminal. Generous free tier (60 req/min, 1000/day).
* [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 84,808 | 🐛 525 | 🌐 TypeScript | 📅 2026-08-22 - Open-source AI-driven development agent with CLI, GUI, and cloud modes, supporting Claude, GPT, and other models.
* [charmbracelet/crush](https://github.com/charmbracelet/crush) ⭐ 27,589 | 🐛 664 | 🌐 Go | 📅 2026-08-23 - "The glamorous AI coding agent for your favourite terminal", multi-model with beautiful TUI.
* [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) ⭐ 27,299 | 🐛 1,173 | 🌐 TypeScript | 📅 2026-08-23 - "qwen-code is a coding agent that lives in digital world".
* [HKUDS/DeepCode](https://github.com/HKUDS/DeepCode) ⭐ 16,408 | 🐛 34 | 🌐 Python | 📅 2026-08-19 - Deep learning for code analysis and generation. Achieves SOTA on PaperBench.
* [Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,592 | 🐛 60 | 🌐 Go | 📅 2025-10-03 - Terminal-based AI coding agent with REPL mode for planning and executing complex tasks across multiple files, 2M token context.
* [kimi-cli](https://github.com/MoonshotAI/kimi-cli) ⭐ 11,239 | 🐛 833 | 🌐 Python | 📅 2026-08-03 - Official command-line interface for Kimi, an AI assistant that helps with coding tasks and development workflows.
...
* [GitHub Copilot CLI](https://github.com/github/copilot-cli) ⭐ 11,111 | 🐛 2,177 | 🌐 Shell | 📅 2026-08-21 - Full agentic development environment in the terminal with Autopilot mode, multi-model support, and GitHub integration. GA since Feb 2026.
* [aichat](https://github.com/sigoden/aichat) ⭐ 10,380 | 🐛 96 | 🌐 Rust | 📅 2026-02-23 - All-in-one LLM CLI tool featuring shell assistant, REPL mode, RAG, AI tools and agents, supporting 20+ providers.
* [Cloudflare/vibesdk](https://github.com/cloudflare/vibesdk) ⭐ 5,327 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-20 - Cloudflare's SDK for vibe coding.
* [mistralai/mistral-vibe](https://github.com/mistralai/mistral-vibe) ⭐ 4,865 | 🐛 278 | 🌐 Python | 📅 2026-08-20 - Mistral AI's vibe coding tool.
* [gptme](https://github.com/ErikBjare/gptme) ⭐ 4,392 | 🐛 17 | 🌐 Python | 📅 2026-08-23 - A personal AI agent in your terminal, equipped with local tools for coding, shell commands, file editing, and web browsing.
...
* [onWatch](https://github.com/onllm-dev/onwatch) ⭐ 716 | 🐛 7 | 🌐 Go | 📅 2026-08-20 - Open-source Go CLI that tracks AI API quota usage across 7 providers (Anthropic, OpenAI, GitHub Copilot, MiniMax, and more). Works with Claude Code, Codex CLI, Cursor, Cline, and other vibe coding tools. Background daemon, <50MB RAM, zero telemetry.
...
* [Claude Task Master](https://github.com/eyaltoledano/claude-task-master) ⭐ 28,012 | 🐛 212 | 🌐 JavaScript | 📅 2026-04-28 - An AI-powered task-management system you can drop into Cursor, Lovable, Windsurf, Roo, and others.
* 🔥 [vibe-kanban](https://github.com/BloopAI/vibe-kanban) ⭐ 27,886 | 🐛 533 | 🌐 Rust | 📅 2026-04-24 - A kanban board to manage and orchestrate AI coding agents. Supports 10+ coding agents.
* [Archon](https://github.com/coleam00/Archon) ⭐ 23,255 | 🐛 272 | 🌐 TypeScript | 📅 2026-08-23 - Knowledge and task management backbone for AI coding assistants via MCP.
...
* [AI-DLC Workflows (AWS Labs)](https://github.com/awslabs/aidlc-workflows) ⭐ 4,131 | 🐛 166 | 🌐 Python | 📅 2026-08-23 - AI-Driven Development Life Cycle workflow rules for coding agents. Supports Kiro, Q Developer, Cursor, Cline, Claude Code.
...
* [Context7](https://github.com/upstash/context7) ⭐ 61,095 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-21 - Delivers up-to-date, version-specific documentation directly into LLM prompts. MCP server + CLI.
* [awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules) ⭐ 40,641 | 🐛 55 | 🌐 JavaScript | 📅 2026-05-30 - Curated collection of `.cursorrules` configuration files for the Cursor AI editor.
* [EnzeD/vibe-coding](https://github.com/EnzeD/vibe-coding) ⭐ 4,763 | 🐛 0 | 📅 2026-05-25 - The Ultimate Guide to Vibe Coding with best practices and tips.
* [KhazP/vibe-coding-prompt-template](https://github.com/KhazP/vibe-coding-prompt-template) ⭐ 2,861 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-21 - A prompt template for vibe coding.
...
* [claude-reflect](https://github.com/BayramAnnakov/claude-reflect) ⭐ 1,412 | 🐛 16 | 🌐 Python | 📅 2026-03-16 - Self-learning system for Claude Code that captures corrections and syncs approved learnings to CLAUDE.md files.
...
* [Claude Code Organizer](https://github.com/mcpware/claude-code-organizer) ⭐ 370 | 🐛 11 | 🌐 JavaScript | 📅 2026-06-07 - Visual dashboard and MCP server to organize Claude Code memories, skills, MCP servers, and hooks with scope hierarchy and drag-and-drop.
...
* [Mysti](https://github.com/DeepMyst/Mysti) ⭐ 1,134 | 🐛 16 | 🌐 TypeScript | 📅 2026-07-05 - Multi-agent AI coding assistant for VS Code. Claude Code, Codex, Gemini, and GitHub Copilot brainstorm together and deliver collaborative solutions.
