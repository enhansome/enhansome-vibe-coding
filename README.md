...
* [continuedev/continue](https://github.com/continuedev/continue) ⭐ 35,953 | 🐛 968 | 🌐 TypeScript | 📅 2026-09-18 - Open-source AI code agent with IDE extensions, CLI tool, and source-controlled AI checks enforceable in CI.
* [Tabby](https://github.com/TabbyML/tabby) ⭐ 33,881 | 🐛 338 | 🌐 Rust | 📅 2026-06-30 - Self-hosted AI coding assistant, open-source alternative to GitHub Copilot with code completion and repository-level context.
* [avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,168 | 🐛 46 | 🌐 Lua | 📅 2026-09-18 - Neovim plugin designed to emulate the behavior of the Cursor AI IDE with AI-driven code suggestions.
...
* [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,864 | 🐛 15 | 🌐 Lua | 📅 2026-09-18 - Neovim plugin for AI-assisted coding with agents, slash commands, and multiple LLM support.
* [Junie](https://github.com/JetBrains/Junie) ⭐ 440 | 🐛 64 | 🌐 Shell | 📅 2026-09-18 - LLM-agnostic coding agent by JetBrains for terminal, IDE, and CI/CD.
...
* [bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,890 | 🐛 139 | 🌐 TypeScript | 📅 2026-02-07 - Open-source version of Bolt.new with Electron desktop apps, 19+ AI providers, and local model support via Ollama.

* [Superset](https://github.com/superset-sh/superset) ⭐ 14,388 | 🐛 722 | 🌐 TypeScript | 📅 2026-09-19 - Desktop app to orchestrate multiple AI coding agents in parallel (Claude Code, Codex, etc.) with Git worktree isolation.
...
* 🔥 [anthropics/claude-code](https://github.com/anthropics/claude-code) ⭐ 146,440 | 🐛 12,462 | 🌐 TypeScript | 📅 2026-09-19 - Coding agent that understands your codebase, automates tasks, explains code, and manages Git, all via natural language.
* [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 125,215 | 🐛 17,812 | 🌐 Rust | 📅 2026-09-19 - OpenAI's coding agent in the terminal with Codex Cloud, IDE extension, and multi-model support.
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,076 | 🐛 837 | 🌐 TypeScript | 📅 2026-09-19 - An open-source AI agent from Google that brings the power of Gemini directly into your terminal. Generous free tier (60 req/min, 1000/day).
* [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 88,473 | 🐛 827 | 🌐 TypeScript | 📅 2026-09-19 - Open-source AI-driven development agent with CLI, GUI, and cloud modes, supporting Claude, GPT, and other models.
* [charmbracelet/crush](https://github.com/charmbracelet/crush) ⭐ 28,182 | 🐛 766 | 🌐 Go | 📅 2026-09-19 - "The glamorous AI coding agent for your favourite terminal", multi-model with beautiful TUI.
* [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) ⭐ 27,976 | 🐛 1,469 | 🌐 TypeScript | 📅 2026-09-19 - "qwen-code is a coding agent that lives in digital world".
* [HKUDS/DeepCode](https://github.com/HKUDS/DeepCode) ⭐ 16,574 | 🐛 18 | 🌐 Python | 📅 2026-09-17 - Deep learning for code analysis and generation. Achieves SOTA on PaperBench.
...
* [kimi-cli](https://github.com/MoonshotAI/kimi-cli) ⭐ 11,403 | 🐛 809 | 🌐 Python | 📅 2026-09-01 - Official command-line interface for Kimi, an AI assistant that helps with coding tasks and development workflows.
...
* [GitHub Copilot CLI](https://github.com/github/copilot-cli) ⭐ 11,183 | 🐛 2,377 | 🌐 Shell | 📅 2026-09-18 - Full agentic development environment in the terminal with Autopilot mode, multi-model support, and GitHub integration. GA since Feb 2026.
* [aichat](https://github.com/sigoden/aichat) ⭐ 10,455 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - All-in-one LLM CLI tool featuring shell assistant, REPL mode, RAG, AI tools and agents, supporting 20+ providers.
* [Cloudflare/vibesdk](https://github.com/cloudflare/vibesdk) ⭐ 5,371 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-08 - Cloudflare's SDK for vibe coding.
* [mistralai/mistral-vibe](https://github.com/mistralai/mistral-vibe) ⭐ 4,969 | 🐛 309 | 🌐 Python | 📅 2026-09-18 - Mistral AI's vibe coding tool.
* [gptme](https://github.com/ErikBjare/gptme) ⭐ 4,418 | 🐛 16 | 🌐 Python | 📅 2026-09-19 - A personal AI agent in your terminal, equipped with local tools for coding, shell commands, file editing, and web browsing.
...
* [pyscn](https://github.com/ludo-technologies/pyscn) ⭐ 1,068 | 🐛 10 | 🌐 Go | 📅 2026-09-18 - Code quality analyzer for vibe-coded Python. Detects dead code, clones, complexity issues, and coupling problems with MCP integration for AI assistants.
* [onWatch](https://github.com/onllm-dev/onwatch) ⭐ 743 | 🐛 9 | 🌐 Go | 📅 2026-09-18 - Open-source Go CLI that tracks AI API quota usage across 7 providers (Anthropic, OpenAI, GitHub Copilot, MiniMax, and more). Works with Claude Code, Codex CLI, Cursor, Cline, and other vibe coding tools. Background daemon, <50MB RAM, zero telemetry.
...
* 🔥 [vibe-kanban](https://github.com/BloopAI/vibe-kanban) ⭐ 28,126 | 🐛 536 | 🌐 Rust | 📅 2026-09-19 - A kanban board to manage and orchestrate AI coding agents. Supports 10+ coding agents.
...
* [Archon](https://github.com/coleam00/Archon) ⭐ 23,503 | 🐛 375 | 🌐 TypeScript | 📅 2026-09-18 - Knowledge and task management backbone for AI coding assistants via MCP.
...
* [AI-DLC Workflows (AWS Labs)](https://github.com/awslabs/aidlc-workflows) ⭐ 4,717 | 🐛 229 | 🌐 TypeScript | 📅 2026-09-19 - AI-Driven Development Life Cycle workflow rules for coding agents. Supports Kiro, Q Developer, Cursor, Cline, Claude Code.
...
* [Context7](https://github.com/upstash/context7) ⭐ 62,187 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-18 - Delivers up-to-date, version-specific documentation directly into LLM prompts. MCP server + CLI.
* [awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules) ⭐ 40,795 | 🐛 77 | 🌐 JavaScript | 📅 2026-05-30 - Curated collection of `.cursorrules` configuration files for the Cursor AI editor.
...
* [llms.txt](https://github.com/AnswerDotAI/llms-txt) ⭐ 2,622 | 🐛 104 | 🌐 Jupyter Notebook | 📅 2026-09-04 - Standardized markdown file specification for making website documentation LLM-friendly.
* [claude-reflect](https://github.com/BayramAnnakov/claude-reflect) ⭐ 1,664 | 🐛 16 | 🌐 Python | 📅 2026-03-16 - Self-learning system for Claude Code that captures corrections and syncs approved learnings to CLAUDE.md files.
