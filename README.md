...
* [continuedev/continue](https://github.com/continuedev/continue) ⭐ 35,967 | 🐛 968 | 🌐 TypeScript | 📅 2026-09-20 - Open-source AI code agent with IDE extensions, CLI tool, and source-controlled AI checks enforceable in CI.
* [Tabby](https://github.com/TabbyML/tabby) ⭐ 33,884 | 🐛 338 | 🌐 Rust | 📅 2026-06-30 - Self-hosted AI coding assistant, open-source alternative to GitHub Copilot with code completion and repository-level context.
* [avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,172 | 🐛 46 | 🌐 Lua | 📅 2026-09-20 - Neovim plugin designed to emulate the behavior of the Cursor AI IDE with AI-driven code suggestions.
...
* [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,864 | 🐛 15 | 🌐 Lua | 📅 2026-09-21 - Neovim plugin for AI-assisted coding with agents, slash commands, and multiple LLM support.
* [Junie](https://github.com/JetBrains/Junie) ⭐ 450 | 🐛 64 | 🌐 Shell | 📅 2026-09-19 - LLM-agnostic coding agent by JetBrains for terminal, IDE, and CI/CD.
...
* [bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,895 | 🐛 138 | 🌐 TypeScript | 📅 2026-02-07 - Open-source version of Bolt.new with Electron desktop apps, 19+ AI providers, and local model support via Ollama.

* [Superset](https://github.com/superset-sh/superset) ⭐ 14,428 | 🐛 735 | 🌐 TypeScript | 📅 2026-09-21 - Desktop app to orchestrate multiple AI coding agents in parallel (Claude Code, Codex, etc.) with Git worktree isolation.

* [Parallel Code](https://github.com/johannesjo/parallel-code) ⭐ 1,014 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-19 - Desktop app for running multiple AI coding agents (Claude Code, Codex CLI, Gemini CLI) simultaneously in isolated git worktrees.
...
* 🔥 [anthropics/claude-code](https://github.com/anthropics/claude-code) ⭐ 147,333 | 🐛 12,249 | 🌐 TypeScript | 📅 2026-09-20 - Coding agent that understands your codebase, automates tasks, explains code, and manages Git, all via natural language.
* [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 125,639 | 🐛 18,071 | 🌐 Rust | 📅 2026-09-21 - OpenAI's coding agent in the terminal with Codex Cloud, IDE extension, and multi-model support.
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,102 | 🐛 838 | 🌐 TypeScript | 📅 2026-09-21 - An open-source AI agent from Google that brings the power of Gemini directly into your terminal. Generous free tier (60 req/min, 1000/day).
* [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 88,687 | 🐛 872 | 🌐 TypeScript | 📅 2026-09-21 - Open-source AI-driven development agent with CLI, GUI, and cloud modes, supporting Claude, GPT, and other models.
* [charmbracelet/crush](https://github.com/charmbracelet/crush) ⭐ 28,217 | 🐛 772 | 🌐 Go | 📅 2026-09-21 - "The glamorous AI coding agent for your favourite terminal", multi-model with beautiful TUI.
* [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) ⭐ 28,036 | 🐛 1,507 | 🌐 TypeScript | 📅 2026-09-21 - "qwen-code is a coding agent that lives in digital world".
* [HKUDS/DeepCode](https://github.com/HKUDS/DeepCode) ⭐ 16,604 | 🐛 21 | 🌐 Python | 📅 2026-09-17 - Deep learning for code analysis and generation. Achieves SOTA on PaperBench.
* [Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,648 | 🐛 62 | 🌐 Go | 📅 2025-10-03 - Terminal-based AI coding agent with REPL mode for planning and executing complex tasks across multiple files, 2M token context.
* [kimi-cli](https://github.com/MoonshotAI/kimi-cli) ⭐ 11,418 | 🐛 794 | 🌐 Python | 📅 2026-09-01 - Official command-line interface for Kimi, an AI assistant that helps with coding tasks and development workflows.
* [claude-engineer](https://github.com/Doriandarko/claude-engineer) ⭐ 11,217 | 🐛 52 | 🌐 Python | 📅 2024-12-12 - A self-improving AI coding assistant CLI built on Claude that can generate and manage its own tools.
* [GitHub Copilot CLI](https://github.com/github/copilot-cli) ⭐ 11,189 | 🐛 2,334 | 🌐 Shell | 📅 2026-09-18 - Full agentic development environment in the terminal with Autopilot mode, multi-model support, and GitHub integration. GA since Feb 2026.
* [aichat](https://github.com/sigoden/aichat) ⭐ 10,462 | 🐛 104 | 🌐 Rust | 📅 2026-02-23 - All-in-one LLM CLI tool featuring shell assistant, REPL mode, RAG, AI tools and agents, supporting 20+ providers.
* [Cloudflare/vibesdk](https://github.com/cloudflare/vibesdk) ⭐ 5,373 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-08 - Cloudflare's SDK for vibe coding.
* [mistralai/mistral-vibe](https://github.com/mistralai/mistral-vibe) ⭐ 4,982 | 🐛 310 | 🌐 Python | 📅 2026-09-18 - Mistral AI's vibe coding tool.
* [gptme](https://github.com/ErikBjare/gptme) ⭐ 4,419 | 🐛 16 | 🌐 Python | 📅 2026-09-21 - A personal AI agent in your terminal, equipped with local tools for coding, shell commands, file editing, and web browsing.
* [superagent-ai/grok-cli](https://github.com/superagent-ai/grok-cli) ⭐ 3,479 | 🐛 33 | 🌐 TypeScript | 📅 2026-07-06 - Command-line interface for AI-powered coding assistance.
* [ai-christianson/RA.Aid](https://github.com/ai-christianson/RA.Aid) ⭐ 2,220 | 🐛 61 | 🌐 Python | 📅 2026-01-30 - A standalone coding agent built on LangGraph's agent-based task execution framework.
* [superagent-ai/vibekit](https://github.com/superagent-ai/vibekit) ⭐ 1,857 | 🐛 37 | 🌐 TypeScript | 📅 2026-01-13 - A toolkit for building vibe coding applications.
* [Gentleman-Programming/gentleman-guardian-angel](https://github.com/Gentleman-Programming/gentleman-guardian-angel) ⭐ 1,163 | 🐛 36 | 🌐 Shell | 📅 2026-07-08 - Provider-agnostic code review using AI. Use Claude, Gemini, Codex, Ollama to enforce your coding standards.
* [pyscn](https://github.com/ludo-technologies/pyscn) ⭐ 1,073 | 🐛 10 | 🌐 Go | 📅 2026-09-21 - Code quality analyzer for vibe-coded Python. Detects dead code, clones, complexity issues, and coupling problems with MCP integration for AI assistants.
* [onWatch](https://github.com/onllm-dev/onwatch) ⭐ 744 | 🐛 4 | 🌐 Go | 📅 2026-09-20 - Open-source Go CLI that tracks AI API quota usage across 7 providers (Anthropic, OpenAI, GitHub Copilot, MiniMax, and more). Works with Claude Code, Codex CLI, Cursor, Cline, and other vibe coding tools. Background daemon, <50MB RAM, zero telemetry.
* [MyCoder.ai](https://github.com/drivecore/mycoder) ⭐ 569 | 🐛 61 | 🌐 TypeScript | 📅 2026-01-07 - Open source AI-powered coding assistant with Git and GitHub integration, featuring parallel execution and self-modification capabilities.
...
* 🔥 [vibe-kanban](https://github.com/BloopAI/vibe-kanban) ⭐ 28,149 | 🐛 538 | 🌐 Rust | 📅 2026-09-19 - A kanban board to manage and orchestrate AI coding agents. Supports 10+ coding agents.
* [Claude Task Master](https://github.com/eyaltoledano/claude-task-master) ⭐ 28,085 | 🐛 212 | 🌐 JavaScript | 📅 2026-04-28 - An AI-powered task-management system you can drop into Cursor, Lovable, Windsurf, Roo, and others.
* [Archon](https://github.com/coleam00/Archon) ⭐ 23,515 | 🐛 363 | 🌐 TypeScript | 📅 2026-09-20 - Knowledge and task management backbone for AI coding assistants via MCP.
* [CCPM (Claude Code PM)](https://github.com/automazeio/ccpm) ⭐ 8,382 | 🐛 4 | 🌐 Shell | 📅 2026-03-18 - Project management for Claude Code using GitHub Issues and Git worktrees for parallel agent execution.
* [AI-DLC Workflows (AWS Labs)](https://github.com/awslabs/aidlc-workflows) ⭐ 4,732 | 🐛 241 | 🌐 TypeScript | 📅 2026-09-21 - AI-Driven Development Life Cycle workflow rules for coding agents. Supports Kiro, Q Developer, Cursor, Cline, Claude Code.
...
* [Context7](https://github.com/upstash/context7) ⭐ 62,264 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-21 - Delivers up-to-date, version-specific documentation directly into LLM prompts. MCP server + CLI.
* [awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules) ⭐ 40,807 | 🐛 78 | 🌐 JavaScript | 📅 2026-05-30 - Curated collection of `.cursorrules` configuration files for the Cursor AI editor.
...
* [KhazP/vibe-coding-prompt-template](https://github.com/KhazP/vibe-coding-prompt-template) ⭐ 3,090 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - A prompt template for vibe coding.
* [llms.txt](https://github.com/AnswerDotAI/llms-txt) ⭐ 2,625 | 🐛 106 | 🌐 Jupyter Notebook | 📅 2026-09-21 - Standardized markdown file specification for making website documentation LLM-friendly.
* [claude-reflect](https://github.com/BayramAnnakov/claude-reflect) ⭐ 1,693 | 🐛 2 | 🌐 Python | 📅 2026-09-20 - Self-learning system for Claude Code that captures corrections and syncs approved learnings to CLAUDE.md files.
...
* [Claude Code Organizer](https://github.com/mcpware/claude-code-organizer) ⭐ 379 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-13 - Visual dashboard and MCP server to organize Claude Code memories, skills, MCP servers, and hooks with scope hierarchy and drag-and-drop.
...
* [Mysti](https://github.com/DeepMyst/Mysti) ⭐ 1,140 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-19 - Multi-agent AI coding assistant for VS Code. Claude Code, Codex, Gemini, and GitHub Copilot brainstorm together and deliver collaborative solutions.
