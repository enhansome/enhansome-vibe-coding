...
* [automata/aicodeguide](https://github.com/automata/aicodeguide) ⭐ 2,683 | 🐛 4 | 📅 2026-03-23 - A roadmap to start coding with AI.
...
* [continuedev/continue](https://github.com/continuedev/continue) ⭐ 35,538 | 🐛 952 | 🌐 TypeScript | 📅 2026-08-19 - Open-source AI code agent with IDE extensions, CLI tool, and source-controlled AI checks enforceable in CI.
* [Tabby](https://github.com/TabbyML/tabby) ⭐ 33,828 | 🐛 330 | 🌐 Rust | 📅 2026-06-30 - Self-hosted AI coding assistant, open-source alternative to GitHub Copilot with code completion and repository-level context.
* [avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,119 | 🐛 47 | 🌐 Lua | 📅 2026-08-17 - Neovim plugin designed to emulate the behavior of the Cursor AI IDE with AI-driven code suggestions.
...
* [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,812 | 🐛 12 | 🌐 Lua | 📅 2026-08-18 - Neovim plugin for AI-assisted coding with agents, slash commands, and multiple LLM support.
* [Junie](https://github.com/JetBrains/Junie) ⭐ 397 | 🐛 60 | 🌐 Shell | 📅 2026-08-19 - LLM-agnostic coding agent by JetBrains for terminal, IDE, and CI/CD.
...
* [bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,766 | 🐛 131 | 🌐 TypeScript | 📅 2026-02-07 - Open-source version of Bolt.new with Electron desktop apps, 19+ AI providers, and local model support via Ollama.

* [Superset](https://github.com/superset-sh/superset) ⭐ 13,079 | 🐛 584 | 🌐 TypeScript | 📅 2026-08-19 - Desktop app to orchestrate multiple AI coding agents in parallel (Claude Code, Codex, etc.) with Git worktree isolation.
...
* 🔥 [anthropics/claude-code](https://github.com/anthropics/claude-code) ⭐ 141,978 | 🐛 15,107 | 🌐 Python | 📅 2026-08-18 - Coding agent that understands your codebase, automates tasks, explains code, and manages Git, all via natural language.
* [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 106,808 | 🐛 13,137 | 🌐 Rust | 📅 2026-08-19 - OpenAI's coding agent in the terminal with Codex Cloud, IDE extension, and multi-model support.
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,573 | 🐛 783 | 🌐 TypeScript | 📅 2026-08-19 - An open-source AI agent from Google that brings the power of Gemini directly into your terminal. Generous free tier (60 req/min, 1000/day).
* [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 84,469 | 🐛 484 | 🌐 TypeScript | 📅 2026-08-19 - Open-source AI-driven development agent with CLI, GUI, and cloud modes, supporting Claude, GPT, and other models.
* [charmbracelet/crush](https://github.com/charmbracelet/crush) ⭐ 27,497 | 🐛 647 | 🌐 Go | 📅 2026-08-19 - "The glamorous AI coding agent for your favourite terminal", multi-model with beautiful TUI.
* [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) ⭐ 27,186 | 🐛 1,098 | 🌐 TypeScript | 📅 2026-08-19 - "qwen-code is a coding agent that lives in digital world".
* [HKUDS/DeepCode](https://github.com/HKUDS/DeepCode) ⭐ 16,373 | 🐛 30 | 🌐 Python | 📅 2026-08-19 - Deep learning for code analysis and generation. Achieves SOTA on PaperBench.
...
* [kimi-cli](https://github.com/MoonshotAI/kimi-cli) ⭐ 11,220 | 🐛 832 | 🌐 Python | 📅 2026-08-03 - Official command-line interface for Kimi, an AI assistant that helps with coding tasks and development workflows.
* [GitHub Copilot CLI](https://github.com/github/copilot-cli) ⭐ 11,101 | 🐛 2,144 | 🌐 Shell | 📅 2026-08-19 - Full agentic development environment in the terminal with Autopilot mode, multi-model support, and GitHub integration. GA since Feb 2026.
* [aichat](https://github.com/sigoden/aichat) ⭐ 10,370 | 🐛 95 | 🌐 Rust | 📅 2026-02-23 - All-in-one LLM CLI tool featuring shell assistant, REPL mode, RAG, AI tools and agents, supporting 20+ providers.
* [Cloudflare/vibesdk](https://github.com/cloudflare/vibesdk) ⭐ 5,322 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-19 - Cloudflare's SDK for vibe coding.
* [mistralai/mistral-vibe](https://github.com/mistralai/mistral-vibe) ⭐ 4,847 | 🐛 264 | 🌐 Python | 📅 2026-08-18 - Mistral AI's vibe coding tool.
* [gptme](https://github.com/ErikBjare/gptme) ⭐ 4,390 | 🐛 15 | 🌐 Python | 📅 2026-08-19 - A personal AI agent in your terminal, equipped with local tools for coding, shell commands, file editing, and web browsing.
* [superagent-ai/grok-cli](https://github.com/superagent-ai/grok-cli) ⭐ 3,416 | 🐛 31 | 🌐 TypeScript | 📅 2026-07-06 - Command-line interface for AI-powered coding assistance.
...
* [Gentleman-Programming/gentleman-guardian-angel](https://github.com/Gentleman-Programming/gentleman-guardian-angel) ⭐ 1,125 | 🐛 25 | 🌐 Shell | 📅 2026-07-08 - Provider-agnostic code review using AI. Use Claude, Gemini, Codex, Ollama to enforce your coding standards.
...
* [onWatch](https://github.com/onllm-dev/onwatch) ⭐ 713 | 🐛 9 | 🌐 Go | 📅 2026-08-19 - Open-source Go CLI that tracks AI API quota usage across 7 providers (Anthropic, OpenAI, GitHub Copilot, MiniMax, and more). Works with Claude Code, Codex CLI, Cursor, Cline, and other vibe coding tools. Background daemon, <50MB RAM, zero telemetry.
...
* [langchain-code](https://github.com/zamalali/langchain-code) ⭐ 441 | 🐛 4 | 🌐 Python | 📅 2025-11-20 - LangChain-based coding agent for AI-assisted development. Supports Gemini, Anthropic, OpenAI, and Ollama.
...
* [Claude Task Master](https://github.com/eyaltoledano/claude-task-master) ⭐ 28,001 | 🐛 212 | 🌐 JavaScript | 📅 2026-04-28 - An AI-powered task-management system you can drop into Cursor, Lovable, Windsurf, Roo, and others.
* 🔥 [vibe-kanban](https://github.com/BloopAI/vibe-kanban) ⭐ 27,849 | 🐛 534 | 🌐 Rust | 📅 2026-04-24 - A kanban board to manage and orchestrate AI coding agents. Supports 10+ coding agents.
* [Archon](https://github.com/coleam00/Archon) ⭐ 23,226 | 🐛 260 | 🌐 TypeScript | 📅 2026-08-19 - Knowledge and task management backbone for AI coding assistants via MCP.
...
* [AI-DLC Workflows (AWS Labs)](https://github.com/awslabs/aidlc-workflows) ⭐ 4,075 | 🐛 155 | 🌐 Python | 📅 2026-08-19 - AI-Driven Development Life Cycle workflow rules for coding agents. Supports Kiro, Q Developer, Cursor, Cline, Claude Code.
...
* [Context7](https://github.com/upstash/context7) ⭐ 60,966 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-19 - Delivers up-to-date, version-specific documentation directly into LLM prompts. MCP server + CLI.
* [awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules) ⭐ 40,611 | 🐛 53 | 🌐 JavaScript | 📅 2026-05-30 - Curated collection of `.cursorrules` configuration files for the Cursor AI editor.
* [EnzeD/vibe-coding](https://github.com/EnzeD/vibe-coding) ⭐ 4,757 | 🐛 0 | 📅 2026-05-25 - The Ultimate Guide to Vibe Coding with best practices and tips.
* [KhazP/vibe-coding-prompt-template](https://github.com/KhazP/vibe-coding-prompt-template) ⭐ 2,850 | 🐛 0 | 🌐 Python | 📅 2026-07-18 - A prompt template for vibe coding.
* [llms.txt](https://github.com/AnswerDotAI/llms-txt) ⭐ 2,573 | 🐛 100 | 🌐 Jupyter Notebook | 📅 2026-08-10 - Standardized markdown file specification for making website documentation LLM-friendly.
...
* [Mysti](https://github.com/DeepMyst/Mysti) ⭐ 1,129 | 🐛 16 | 🌐 TypeScript | 📅 2026-07-05 - Multi-agent AI coding assistant for VS Code. Claude Code, Codex, Gemini, and GitHub Copilot brainstorm together and deliver collaborative solutions.
