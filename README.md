...
* [continuedev/continue](https://github.com/continuedev/continue) ⭐ 35,482 | 🐛 940 | 🌐 TypeScript | 📅 2026-08-14 - Open-source AI code agent with IDE extensions, CLI tool, and source-controlled AI checks enforceable in CI.
...
* [avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,111 | 🐛 44 | 🌐 Lua | 📅 2026-08-14 - Neovim plugin designed to emulate the behavior of the Cursor AI IDE with AI-driven code suggestions.
* [copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,676 | 🐛 63 | 🌐 Vim Script | 📅 2026-08-11 - Official GitHub Copilot plugin for Vim/Neovim.
* [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,799 | 🐛 15 | 🌐 Lua | 📅 2026-08-12 - Neovim plugin for AI-assisted coding with agents, slash commands, and multiple LLM support.
...
* [Junie](https://github.com/JetBrains/Junie) ⭐ 369 | 🐛 61 | 🌐 Shell | 📅 2026-08-15 - LLM-agnostic coding agent by JetBrains for terminal, IDE, and CI/CD.
...
* [bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,748 | 🐛 131 | 🌐 TypeScript | 📅 2026-02-07 - Open-source version of Bolt.new with Electron desktop apps, 19+ AI providers, and local model support via Ollama.

* [Superset](https://github.com/superset-sh/superset) ⭐ 12,924 | 🐛 564 | 🌐 TypeScript | 📅 2026-08-15 - Desktop app to orchestrate multiple AI coding agents in parallel (Claude Code, Codex, etc.) with Git worktree isolation.
...
* 🔥 [anthropics/claude-code](https://github.com/anthropics/claude-code) ⭐ 141,490 | 🐛 16,118 | 🌐 Python | 📅 2026-08-14 - Coding agent that understands your codebase, automates tasks, explains code, and manages Git, all via natural language.
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,522 | 🐛 833 | 🌐 TypeScript | 📅 2026-08-15 - An open-source AI agent from Google that brings the power of Gemini directly into your terminal. Generous free tier (60 req/min, 1000/day).
* [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 105,990 | 🐛 12,634 | 🌐 Rust | 📅 2026-08-15 - OpenAI's coding agent in the terminal with Codex Cloud, IDE extension, and multi-model support.
* [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 84,074 | 🐛 482 | 🌐 TypeScript | 📅 2026-08-15 - Open-source AI-driven development agent with CLI, GUI, and cloud modes, supporting Claude, GPT, and other models.
* [charmbracelet/crush](https://github.com/charmbracelet/crush) ⭐ 27,382 | 🐛 630 | 🌐 Go | 📅 2026-08-14 - "The glamorous AI coding agent for your favourite terminal", multi-model with beautiful TUI.
* [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) ⭐ 27,011 | 🐛 1,007 | 🌐 TypeScript | 📅 2026-08-15 - "qwen-code is a coding agent that lives in digital world".
* [HKUDS/DeepCode](https://github.com/HKUDS/DeepCode) ⭐ 16,356 | 🐛 27 | 🌐 Python | 📅 2026-08-14 - Deep learning for code analysis and generation. Achieves SOTA on PaperBench.
* [Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,585 | 🐛 60 | 🌐 Go | 📅 2025-10-03 - Terminal-based AI coding agent with REPL mode for planning and executing complex tasks across multiple files, 2M token context.
...
* [kimi-cli](https://github.com/MoonshotAI/kimi-cli) ⭐ 11,180 | 🐛 830 | 🌐 Python | 📅 2026-08-03 - Official command-line interface for Kimi, an AI assistant that helps with coding tasks and development workflows.
* [GitHub Copilot CLI](https://github.com/github/copilot-cli) ⭐ 11,094 | 🐛 2,122 | 🌐 Shell | 📅 2026-08-14 - Full agentic development environment in the terminal with Autopilot mode, multi-model support, and GitHub integration. GA since Feb 2026.
* [aichat](https://github.com/sigoden/aichat) ⭐ 10,349 | 🐛 94 | 🌐 Rust | 📅 2026-02-23 - All-in-one LLM CLI tool featuring shell assistant, REPL mode, RAG, AI tools and agents, supporting 20+ providers.
* [Cloudflare/vibesdk](https://github.com/cloudflare/vibesdk) ⭐ 5,318 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-14 - Cloudflare's SDK for vibe coding.
* [mistralai/mistral-vibe](https://github.com/mistralai/mistral-vibe) ⭐ 4,828 | 🐛 259 | 🌐 Python | 📅 2026-08-13 - Mistral AI's vibe coding tool.
* [gptme](https://github.com/ErikBjare/gptme) ⭐ 4,389 | 🐛 19 | 🌐 Python | 📅 2026-08-15 - A personal AI agent in your terminal, equipped with local tools for coding, shell commands, file editing, and web browsing.
* [superagent-ai/grok-cli](https://github.com/superagent-ai/grok-cli) ⭐ 3,402 | 🐛 29 | 🌐 TypeScript | 📅 2026-07-06 - Command-line interface for AI-powered coding assistance.
...
* [pyscn](https://github.com/ludo-technologies/pyscn) ⭐ 1,032 | 🐛 16 | 🌐 Go | 📅 2026-08-12 - Code quality analyzer for vibe-coded Python. Detects dead code, clones, complexity issues, and coupling problems with MCP integration for AI assistants.
* [onWatch](https://github.com/onllm-dev/onwatch) ⭐ 709 | 🐛 9 | 🌐 Go | 📅 2026-07-31 - Open-source Go CLI that tracks AI API quota usage across 7 providers (Anthropic, OpenAI, GitHub Copilot, MiniMax, and more). Works with Claude Code, Codex CLI, Cursor, Cline, and other vibe coding tools. Background daemon, <50MB RAM, zero telemetry.
...
* 🔥 [vibe-kanban](https://github.com/BloopAI/vibe-kanban) ⭐ 27,803 | 🐛 533 | 🌐 Rust | 📅 2026-04-24 - A kanban board to manage and orchestrate AI coding agents. Supports 10+ coding agents.
* [Archon](https://github.com/coleam00/Archon) ⭐ 23,196 | 🐛 259 | 🌐 TypeScript | 📅 2026-08-14 - Knowledge and task management backbone for AI coding assistants via MCP.
* [CCPM (Claude Code PM)](https://github.com/automazeio/ccpm) ⭐ 8,336 | 🐛 4 | 🌐 Shell | 📅 2026-03-18 - Project management for Claude Code using GitHub Issues and Git worktrees for parallel agent execution.
* [AI-DLC Workflows (AWS Labs)](https://github.com/awslabs/aidlc-workflows) ⭐ 4,020 | 🐛 156 | 🌐 Python | 📅 2026-08-14 - AI-Driven Development Life Cycle workflow rules for coding agents. Supports Kiro, Q Developer, Cursor, Cline, Claude Code.
...
* [Context7](https://github.com/upstash/context7) ⭐ 60,761 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-14 - Delivers up-to-date, version-specific documentation directly into LLM prompts. MCP server + CLI.
* [awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules) ⭐ 40,593 | 🐛 51 | 🌐 JavaScript | 📅 2026-05-30 - Curated collection of `.cursorrules` configuration files for the Cursor AI editor.
* [EnzeD/vibe-coding](https://github.com/EnzeD/vibe-coding) ⭐ 4,751 | 🐛 0 | 📅 2026-05-25 - The Ultimate Guide to Vibe Coding with best practices and tips.
* [KhazP/vibe-coding-prompt-template](https://github.com/KhazP/vibe-coding-prompt-template) ⭐ 2,837 | 🐛 0 | 🌐 Python | 📅 2026-07-18 - A prompt template for vibe coding.
* [llms.txt](https://github.com/AnswerDotAI/llms-txt) ⭐ 2,563 | 🐛 100 | 🌐 Jupyter Notebook | 📅 2026-08-10 - Standardized markdown file specification for making website documentation LLM-friendly.
* [claude-reflect](https://github.com/BayramAnnakov/claude-reflect) ⭐ 1,404 | 🐛 16 | 🌐 Python | 📅 2026-03-16 - Self-learning system for Claude Code that captures corrections and syncs approved learnings to CLAUDE.md files.
...
* [Mysti](https://github.com/DeepMyst/Mysti) ⭐ 1,125 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-05 - Multi-agent AI coding assistant for VS Code. Claude Code, Codex, Gemini, and GitHub Copilot brainstorm together and deliver collaborative solutions.
