...
* [continuedev/continue](https://github.com/continuedev/continue) ⭐ 35,814 | 🐛 946 | 🌐 TypeScript | 📅 2026-09-07 - Open-source AI code agent with IDE extensions, CLI tool, and source-controlled AI checks enforceable in CI.
* [Tabby](https://github.com/TabbyML/tabby) ⭐ 33,868 | 🐛 335 | 🌐 Rust | 📅 2026-06-30 - Self-hosted AI coding assistant, open-source alternative to GitHub Copilot with code completion and repository-level context.
* [avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,152 | 🐛 45 | 🌐 Lua | 📅 2026-09-06 - Neovim plugin designed to emulate the behavior of the Cursor AI IDE with AI-driven code suggestions.
...
* [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,836 | 🐛 15 | 🌐 Lua | 📅 2026-09-06 - Neovim plugin for AI-assisted coding with agents, slash commands, and multiple LLM support.
* [Junie](https://github.com/JetBrains/Junie) ⭐ 428 | 🐛 60 | 🌐 Shell | 📅 2026-09-07 - LLM-agnostic coding agent by JetBrains for terminal, IDE, and CI/CD.
...
* [bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,851 | 🐛 138 | 🌐 TypeScript | 📅 2026-02-07 - Open-source version of Bolt.new with Electron desktop apps, 19+ AI providers, and local model support via Ollama.

* [Superset](https://github.com/superset-sh/superset) ⭐ 13,836 | 🐛 623 | 🌐 TypeScript | 📅 2026-09-07 - Desktop app to orchestrate multiple AI coding agents in parallel (Claude Code, Codex, etc.) with Git worktree isolation.
...
* 🔥 [anthropics/claude-code](https://github.com/anthropics/claude-code) ⭐ 144,316 | 🐛 13,184 | 🌐 Python | 📅 2026-09-06 - Coding agent that understands your codebase, automates tasks, explains code, and manages Git, all via natural language.
* [OpenAI Codex CLI](https://github.com/openai/codex) ⭐ 122,094 | 🐛 15,676 | 🌐 Rust | 📅 2026-09-07 - OpenAI's coding agent in the terminal with Codex Cloud, IDE extension, and multi-model support.
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,845 | 🐛 836 | 🌐 TypeScript | 📅 2026-09-07 - An open-source AI agent from Google that brings the power of Gemini directly into your terminal. Generous free tier (60 req/min, 1000/day).
* [OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 86,406 | 🐛 672 | 🌐 TypeScript | 📅 2026-09-07 - Open-source AI-driven development agent with CLI, GUI, and cloud modes, supporting Claude, GPT, and other models.
* [charmbracelet/crush](https://github.com/charmbracelet/crush) ⭐ 27,940 | 🐛 693 | 🌐 Go | 📅 2026-09-07 - "The glamorous AI coding agent for your favourite terminal", multi-model with beautiful TUI.
* [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) ⭐ 27,689 | 🐛 1,343 | 🌐 TypeScript | 📅 2026-09-07 - "qwen-code is a coding agent that lives in digital world".
* [HKUDS/DeepCode](https://github.com/HKUDS/DeepCode) ⭐ 16,498 | 🐛 18 | 🌐 Python | 📅 2026-09-06 - Deep learning for code analysis and generation. Achieves SOTA on PaperBench.
* [Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,625 | 🐛 62 | 🌐 Go | 📅 2025-10-03 - Terminal-based AI coding agent with REPL mode for planning and executing complex tasks across multiple files, 2M token context.
* [kimi-cli](https://github.com/MoonshotAI/kimi-cli) ⭐ 11,333 | 🐛 824 | 🌐 Python | 📅 2026-09-01 - Official command-line interface for Kimi, an AI assistant that helps with coding tasks and development workflows.
...
* [GitHub Copilot CLI](https://github.com/github/copilot-cli) ⭐ 11,137 | 🐛 2,303 | 🌐 Shell | 📅 2026-09-04 - Full agentic development environment in the terminal with Autopilot mode, multi-model support, and GitHub integration. GA since Feb 2026.
...
* [Cloudflare/vibesdk](https://github.com/cloudflare/vibesdk) ⭐ 5,346 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-07 - Cloudflare's SDK for vibe coding.
* [mistralai/mistral-vibe](https://github.com/mistralai/mistral-vibe) ⭐ 4,925 | 🐛 287 | 🌐 Python | 📅 2026-09-04 - Mistral AI's vibe coding tool.
* [gptme](https://github.com/ErikBjare/gptme) ⭐ 4,410 | 🐛 33 | 🌐 Python | 📅 2026-09-07 - A personal AI agent in your terminal, equipped with local tools for coding, shell commands, file editing, and web browsing.
...
* [superagent-ai/vibekit](https://github.com/superagent-ai/vibekit) ⭐ 1,855 | 🐛 36 | 🌐 TypeScript | 📅 2026-01-13 - A toolkit for building vibe coding applications.
...
* [pyscn](https://github.com/ludo-technologies/pyscn) ⭐ 1,042 | 🐛 18 | 🌐 Go | 📅 2026-09-06 - Code quality analyzer for vibe-coded Python. Detects dead code, clones, complexity issues, and coupling problems with MCP integration for AI assistants.
* [onWatch](https://github.com/onllm-dev/onwatch) ⭐ 728 | 🐛 8 | 🌐 Go | 📅 2026-09-06 - Open-source Go CLI that tracks AI API quota usage across 7 providers (Anthropic, OpenAI, GitHub Copilot, MiniMax, and more). Works with Claude Code, Codex CLI, Cursor, Cline, and other vibe coding tools. Background daemon, <50MB RAM, zero telemetry.
...
* 🔥 [vibe-kanban](https://github.com/BloopAI/vibe-kanban) ⭐ 28,029 | 🐛 539 | 🌐 Rust | 📅 2026-04-24 - A kanban board to manage and orchestrate AI coding agents. Supports 10+ coding agents.
* [Archon](https://github.com/coleam00/Archon) ⭐ 23,396 | 🐛 306 | 🌐 TypeScript | 📅 2026-09-02 - Knowledge and task management backbone for AI coding assistants via MCP.
* [CCPM (Claude Code PM)](https://github.com/automazeio/ccpm) ⭐ 8,362 | 🐛 4 | 🌐 Shell | 📅 2026-03-18 - Project management for Claude Code using GitHub Issues and Git worktrees for parallel agent execution.
* [AI-DLC Workflows (AWS Labs)](https://github.com/awslabs/aidlc-workflows) ⭐ 4,396 | 🐛 150 | 🌐 TypeScript | 📅 2026-09-07 - AI-Driven Development Life Cycle workflow rules for coding agents. Supports Kiro, Q Developer, Cursor, Cline, Claude Code.
...
* [Context7](https://github.com/upstash/context7) ⭐ 61,719 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-07 - Delivers up-to-date, version-specific documentation directly into LLM prompts. MCP server + CLI.
* [awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules) ⭐ 40,736 | 🐛 60 | 🌐 JavaScript | 📅 2026-05-30 - Curated collection of `.cursorrules` configuration files for the Cursor AI editor.
...
* [KhazP/vibe-coding-prompt-template](https://github.com/KhazP/vibe-coding-prompt-template) ⭐ 3,044 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-05 - A prompt template for vibe coding.
* [llms.txt](https://github.com/AnswerDotAI/llms-txt) ⭐ 2,604 | 🐛 102 | 🌐 Jupyter Notebook | 📅 2026-09-04 - Standardized markdown file specification for making website documentation LLM-friendly.
